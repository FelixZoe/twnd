...
import cc.felixzoe.dto.ArticleCommentPageQueryDTO;
import cc.felixzoe.dto.ArticleCommentReplyDTO;
import cc.felixzoe.entity.ArticleComments;
import cc.felixzoe.exception.ValidationException;
import cc.felixzoe.mapper.ArticleCommentMapper;
...
public class ArticleCommentServiceImpl implements ArticleCommentService {
    ...
    public void adminReply(ArticleCommentReplyDTO articleCommentReplyDTO, HttpServletRequest request) {
        ...
        // 检查父评论是否开启邮箱通知
        notifyParentIfNeeded(articleCommentReplyDTO.getParentId(), "FelixZoe",
