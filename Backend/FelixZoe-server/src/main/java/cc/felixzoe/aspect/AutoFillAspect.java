package cc.felixzoe.aspect;

import cc.felixzoe.annotation.AutoFill;
import cc.felixzoe.constant.AutoFillConstant;
...
public class AutoFillAspect {
     ...
     * 切入点
     */
    @Pointcut("execution(* cc.felixzoe.mapper.*.*(..)) && @annotation(cc.felixzoe.annotation.AutoFill)")
