...
drop database if exists FelixZoe;
create database FelixZoe;

use FelixZoe;

-- ===========管理端(admin.felixzoe.cc)相关表====================
-- 管理员表
create table admin(
...
-- 密码需要到测试类中生成，在/src/test/java/cc/felixzoe/FelixZoeBackendApplicationTests.java
...
INSERT INTO personal_info (id, nickname, tag, description, avatar, website, email, github, location, create_time, update_time) VALUES
(1, 'FelixZoe', '全栈开发者', '热爱编程，热爱生活', '', 'http://47.238.123.198', '', 'https://github.com/FelixZoe', '中国', NOW(), NOW());

INSERT INTO social_media (name, icon, link, sort, is_visible, create_time, update_time) VALUES
('GitHub', 'fab fa-github', 'https://github.com/FelixZoe', 1, 1, NOW(), NOW()),
('邮箱', 'fas fa-envelope', 'mailto:admin@felixzoe.cc', 2, 1, NOW(), NOW());
